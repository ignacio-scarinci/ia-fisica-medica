...
author: "Curso de IA en Física Médica"
format:
  revealjs:
    slide-number: true
    transition: fade
    ...
    margin: 0.08
    mermaid-format: svg
    footer: "IA en Física Médica · Unidad 2"
execute:
  echo: false
  warning: false
  message: false
...
![¿Qué significa que una segmentación sea buena?](./imagenes/segmentacion_buena.jpg)

---

## No existe una única noción de calidad

![Calidad](./imagenes/calidad.jpg)

---

## Antes de las métricas: TP, FP, FN y TN

![Matriz de confusión](./imagenes/tp_fp_fn_tn.jpg)
...
![Dice](./imagenes/dice.jpg)

---

## Intuición geométrica del Dice

![Intuición geométrica del Dice](./imagenes/intuicion_dice.jpg)

---

## Un ejemplo simple

![Ejemplo simple](./imagenes/ejemplo_dice.jpg)
...
![Estructuras grandes y pequeñas](./imagenes/tamano_estructura.jpg)
...
![Metrica vs. pérdida](./imagenes/metrica_perdida.jpg)

---

## Binary Cross-Entropy: decisión vóxel a vóxel

![Binary Crss-Entropy](./imagenes/bce.jpg)

---

## El problema: fondo ≫ estructura

![Desbalance de clases](./imagenes/fondo_vs_estructura.jpg)

---

## Dice Loss: optimizar la superposición

![Dice Loss](./imagenes/dice_loss.jpg)

---

## Cross-Entropy + Dice

![CE + Dice](./imagenes/ce_dice.jpg)

---

## Focal Loss: cuando predominan los ejemplos fáciles

![Focal Loss](./imagenes/focal_loss.jpg)
...
![Distancia dirigida](./imagenes/distancia.jpg)
---
...
![Dice y Distancia](./imagenes/dice_distancia.jpg)
...
![Promedio vs. dispersión](./imagenes/dice_per_voxel_paciente.jpg)
...
Durante el entrenamiento podemos seguir:

- *training loss*;
- *validation loss*;
- Dice por estructura;
- HD95;
- ejemplos visuales representativos.
...
flowchart LR
    ...
    E --> H[HD95]
    E --> Q[Revisión visual]
    L --> S[Selección del modelo]
    D --> S
    H --> S
    Q --> S
```

> La mejor *loss* no necesariamente corresponde al mejor comportamiento clínico.
